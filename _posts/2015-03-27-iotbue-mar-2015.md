...
I gave a workshop with the Internet of Things Buenos Aires community [IoT/Bue](https://www.meetup.com/IoT-Buenos-Aires/){:target="_blank" rel="noopener"}.We came up with a 'remix' version of the Nest, which we called NestRemix. You can find the code [here](https://github.com/IotBue/nestRemix){:target="_blank" rel="noopener"}.
