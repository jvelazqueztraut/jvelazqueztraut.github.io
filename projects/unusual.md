...
---
Audio reactive sign for the [Unusual](https://www.instagram.com/unusual.london/){:target="_blank" rel="noopener"} party in London.
...
I designed and developed this hanging sign based on an ESP32 with a custom firmware at first that I then migrated to [WLED](https://kno.wled.ge/){:target="_blank" rel="noopener"}. The LED strips are set up in the shape of the letters to allow for beautiful swirling effects per letter:
...
More pics of the sign on its debut date in [this post](https://www.instagram.com/p/CV0mL0UPyYA/){:target="_blank" rel="noopener"}.
